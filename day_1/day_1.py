class EasterBunnyMap:
    ...
    def do_step(self, direction, steps):
        ...
        self.current_position[0] += movement[0]*steps
        self.current_position[1] += movement[1]*steps
...
if __name__ == '__main__':
    ...
    ebm.walk_the_walk()
    print ("Steps from Easter Bunny Headquarters: %d" % (abs(ebm.current_position[0]) + abs(ebm.current_position[1])))
